...
#[test]
fn notification_view_retains_actionable_notifications_in_center() {
    let request = NotificationRequest::new(
        9,
        "App".to_owned(),
        String::new(),
    ...
    assert!(request.into_view(1).stays_in_center());
}

#[test]
fn notification_view_retains_critical_notifications_in_center() {
    let mut hints = HashMap::new();
    hints.insert("urgency".to_owned(), OwnedValue::from(2_u8));
...
#[test]
fn notification_view_treats_normal_notifications_as_ephemeral_center_items() {
    let request = NotificationRequest::new(
        11,
        "App".to_owned(),
        String::new(),
